...
## Project Structure
    ...
    ├── testapiautodatamod_114762  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_114762`
...
2. Clone this repo and `cd testapiautodatamod_114762`
